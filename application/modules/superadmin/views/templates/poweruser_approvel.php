  ...
  <body>
   <div class="container">
        <table class="table table-nobordered">
            ...
            <tr >
                <th colspan="3"> <?php echo 'Your Account has been <b>Approved</b>. You can login with your registered email & password.';?> &nbsp; &nbsp; &nbsp; <a href="<?php echo base_url().'signin';?>" class="btn btn-sm btn-info "> Click here to Login</a></th>
            </tr>
