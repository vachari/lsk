...
<style type="text/css">.table>tbody>tr>td, .table>tbody>tr>th, .table>tfoot>tr>td, .table>tfoot>tr>th, .table>thead>tr>td, .table>thead>tr>th {
  ...
  ?>
            ...
            <tr>
            	<th colspan="4"><h2> Welcome to Shoperative <small>Thanks you for joining with us!</small></h2>	</th>
            </tr>
            <tr><td colspan="5">
                Hi,
                <br>   <br> 
                Your Shoperative Account Successfully Registered & Activated As <b>PowerUser</b>.<a href="<?php echo SITE_DOMAIN ?>/signin" class="btn btn-info btn-sm"> Login here </a>
            </td></tr>
            <?php //} ?>
        </table>
    </div>
