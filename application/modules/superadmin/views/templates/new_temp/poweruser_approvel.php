...
<div style="width:60%;float: right">
  ...
  <p style="line-height: 26px;"><b>Welcome to the Shoperative community, India’s national network of Food Co-operatives.</b></p>
  <!--<p style="line-height: 26px;">Dear <b>User</b>,</p>-->
  
  <p style="line-height: 26px;">
 You are approved as a Power-user. You may now start inviting your co-shoppers as your followers and  build your own Food-Cooperative online at Shoperative.in.</p>
 
 <p>Click <a href="<?php echo base_url().'signin';?>" class="btn btn-sm btn-info "> here </a>to invite followers. You will be asked to login first.</p>
