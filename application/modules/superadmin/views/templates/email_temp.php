  ...
  <body>
   <div class="container" style="border:1px solid #eee;">
        <table class="table table-bordered">
            ...
            <tr >
                <th>Link to Login  </th><td> <a href="<?php echo $email_content['link']; ?>" class="btn btn-sm btn-primary">Click here to Login</a></td>
            </tr>
            <tr>
                <th>Password for Login</th><td> <?php echo $email_content['follower_password']; ?></td>
            </tr>
            <?php } ?>
        </table>
    </div>
