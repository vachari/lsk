...
You are registered as a customer following Power-user: <?php echo $name;?> Please confirm your mail id and complete your profile by clicking <a href="<?php echo base_url().'signin';?>" class="btn btn-sm btn-info "> here </p>
</a>
 <p style="line-height: 26px;"> You will be asked to login first.</p>
   </div>
