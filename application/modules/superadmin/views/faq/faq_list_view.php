  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-1">
           <a href="<?php echo SUPER_ADMIN_FOLDER_PATH; ?>Faqs" class="btn btn-primary pull-right">Refresh</a>
        </div>
               ...
               <?php if($faq_req->code==200){
                ...
                ?>  
                 <tr class="gradeX">
                    ...
                    <?php if($owners_response->faq_option=="1"){?>
                    <td><?php echo 'Knowledge Base'; ?></td>
                    <?php }else if($owners_response->faq_option=="2"){?>
                    <td><?php echo 'About Power User'; ?></td>
                    <?php }else{ ?>
                    <td><?php echo 'Support Forum'; ?></td>
                    <?php } ?>  
                ...
                <?php $sno++; } } else {  ?>
                <tr>
                  <?php if(isset($owners_req->description)){?>
                    <td colspan="4"><div class="alert alert-danger text-center text-upper"><?php echo $owners_req->description; ?></div></td>
                   <?php } else{?> 
                    <td colspan="8"><div class="alert alert-danger text-center text-upper">No faq</div></td>
                   <?php } ?>
                </tr>
                    <?php } ?>
                </tbody>
...
<script language="javascript">
    ...
    if(u.code=='204' || u.code=='301' || u.code=='422'){$('#fail').show();$('#failmessage').html(u.description).addClass('alert alert-danger');setTimeout(function() {window.location=location.href;},2000);}
            ...
            $('#fail').show();
            $('#failmessage').html('*  Please select records').addClass('alert alert-danger');setTimeout(function() {window.location=location.href;},2000);
