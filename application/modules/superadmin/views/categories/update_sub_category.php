...
<head>
  ...
  <title><?php echo PROJECT_NAME;  ?> | Edit Sub Category</title>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="box box-primary">
              ...
              echo form_open_multipart('superadmin/Category/updatesubCategory', $attributes); ?>
              <div class="box-body">
                <div class="col-md-4">
                  <div class="form-group">
                    <?php echo form_hidden('sub_id', $rlt->submenu_id) ?>
                    <?php echo form_hidden('old_banner', $rlt->submenu_banner) ?>
                    <?php echo form_hidden('old_app_icon', $rlt->submenu_app_icon) ?>
                    <?php echo form_label('Choose Category ', 'Choose Category'); ?>
                    ...
                    <select name="menu_id" id="" class="form-control ">
                      ...
                      ?>
                        <option value="<?php echo $result[$i]->menu_id; ?>" <?php
                                                                            if ($rlt->menu_id == $result[$i]->menu_id) {
                                                                              echo 'selected';
                                                                            }
                                                                            ?>>
                          <?php echo $result[$i]->menu_title; ?>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <?php echo form_label('Enter Sub Category', 'Enter Sub Category'); ?>
                    <span style="color:red;"> *</span>
