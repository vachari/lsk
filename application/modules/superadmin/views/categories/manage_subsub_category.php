...
<head>
  ...
  <title><?php echo PROJECT_NAME;  ?> | Manage Sub-sub Category </title>
      ...
      <div class="col-md-12 col-sm-12 ">
        ...
        <div class="col-md-4 ">
          ...
          <div class="col-md-6 pd0 form-inline">
           <input type="search" name="search" id="search" class="form-control" placeholder="Search by Sub-sub Cat">
           </div>
        ...
        <div class="col-md-1">
           <a href="<?php echo SUPER_ADMIN_FOLDER_PATH; ?>Category/createlistsubCategory" class="btn btn-primary pull-right">Add New</a>
           <?php
              ...
              <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <th> Category</th>
                          ...
                          if($result->result_count > 0){
											...
											?>
											<tr class="">
												<td><input type="checkbox"  name="multiple[]" value="<?php echo $row->listsubmenu_id; ?>">  </td>
                        <td><?php echo $i; ?></td>
                        <td> <?php echo $row->listsubmenu_title; ?>(<?php echo $row->listsubmenu_id; ?>) </td>
                          ...
                          <?php
												...
												<td>  
                                                  ...
                                                  foreach ($submenu_result as $submenu) {
                                                      if($row->submenu_id==$submenu->submenu_id){
                                                            echo $submenu->submenu_title;}
                                                      }  
                                                  ?>
												</td>
												<td><?php if(!empty($row->listsubmenu_banner)){ ?>
                        <img src="<?php echo base_url();?>uploads/listsubmenu/<?php echo $row->listsubmenu_banner; ?>" style="width:75px;height:40px" /> 
                        <?php }else{echo "NO IMAGE";} ?>
												</td>
												<td>
                         <?php if(!empty($row->listsubmenu_app_icon)){ ?>
                        <img src="<?php echo base_url();?>uploads/listsubmenu/<?php echo $row->listsubmenu_app_icon; ?>" style="width:75px;height:40px" /> 
                        <?php }else{echo "NO IMAGE";} ?>
                        </td>
												<td><b> 
                        <?php if ($row->flag_status == 1) {
												...
												<td> 
		<a href="<?php echo base_url(); ?>superadmin/deletelistsubmenu/<?php echo $row->listsubmenu_id; ?>" class="btn btn-sm btn-danger " onclick="return confirm('Are you sure?')" title="Delete Sub-sub Category"><i class="glyphicon glyphicon-trash"> </i> </a> 
		<a href="<?php echo base_url(); ?>superadmin/Category/get_listsubCategory/<?php echo $row->listsubmenu_id; ?>" class="btn btn-sm btn-info" title="Edit Sub-sub Category"> <i class="glyphicon glyphicon-edit"> </i> </a>
												</td>
											</tr>
										 <?php 
                        $i++ ;} } else{ ?>
                          <tr><td colspan="8" style="text-align:center; color:red;font-size:20px;">Sub-sub Categories not found</td></tr>
      ...
      // alert(listarray);
        ...
        if (!isNaN(s) && (s == '1' || s == '0') && checklist != '') {
            ...
            $.ajax({
                dataType: 'json',
                type: 'post',
                data: {'tablename': 'listsubmenu', 'updatelist': checklist, 'activity': s},
    ...
    var listarray=new Array();
      ...
      if(checklist!=''){
         ...
         $.ajax({
          dataType:'json',
          type:'post',
          data:{'tablename':'listsubmenu','updatelist':checklist},
