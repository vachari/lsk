...
<head>
  ...
  <title><?php echo PROJECT_NAME;  ?> | Edit Slider </title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo SUPER_ADMIN_FOLDER_PATH;?>Category/manageslider/"><i class="fa fa-dashboard"></i> Manage Slider</a></li>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <a href="<?php echo SUPER_ADMIN_FOLDER_PATH;?>Category/manageslider" class="btn btn-primary pull-right">Go Back</a>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <?php
