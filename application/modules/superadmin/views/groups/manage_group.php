...
<head>
  ...
  <title><?php echo PROJECT_NAME;  ?> | Manage Groups </title>
      ...
      <div class="col-md-12 col-sm-12 ">
        <div class="col-md-4 ">
          ...
          <div class="col-md-9  ">
           ...
           <input type="search" name="search" class="form-control" placeholder="Search by group name">
           </div>
            <div class="col-md-2  ">
        ...
        <div class="col-md-1">
           <a href="<?php echo SUPER_ADMIN_FOLDER_PATH;?>Settings/createGroups" class="btn btn-primary pull-right">Add New</a>
        </div>
      </div>
...
//     echo $re;
// } 
$groups=json_decode($common_result);
?>
                        <thead>
                        ...
                        <tbody>
                            <?php
                            $i = 1;
                            if($groups->common_result!=null){
                            foreach ($groups->common_result as $row) {
                                ?>
                                <tr class="">
                                    ...
                                    <td> 
                                        ...
                                        <a href="<?php echo base_url(); ?>superadmin/Settings/getGroups/<?php echo $row->id; ?>" class="btn btn-sm btn-info"> Edit <i class="glyphicon glyphicon-edit"> </i> </a>
                                    </td>
                                </tr>
                        <?php
                        $i++;
                    }}else{ ?>
                      <tr><td colspan="7" style="text-align:center; color:red;font-size:20px;">Groups Not Found</td></tr> 
                     <?php } ?>

                        </tbody>
                    </table>
              <div class="text-center">
              <td colspan="7" > <p class="pages"><?php echo $links; ?></p></td>
              </div>
                    </div></div></div>
            </div>
            <!-- /.box-body -->
    ...
    var listarray=new Array();
      ...
      if(checklist!=''){
         ...
         $.ajax({
          dataType:'json',
          type:'post',
          data:{'tablename':'groups','updatelist':checklist},
