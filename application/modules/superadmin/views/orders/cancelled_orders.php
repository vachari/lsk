    ...
    width: 230px;" value="<?php echo set_value('search_name');?>">
        ...
        <div class="col-md-8">
          ...
          <input type="text" name="from_date" id="datepicker" class="pdinput" placeholder="From Date" autocomplete="off" value="<?php echo set_value('from_date');?>">
            ...
            <!--
			I commented other than delete so that if needed we can uncomment
      ...
      <div class="col-md-12"> <br>
		  ...
		  <a href="javascript:void(0)"><button type="button" class="btn btn-danger" onclick="orderStatusUpdate('5')" >Delete</button></a>
          </div>    
                            ...
                            <tbody>                              
                                ...
                                <h4>
                                    ...
                                    <td> <?php 
                                     ...
                                     ?></td>
									 <td><?php
										if(!empty($ol->item_cancelled_date)){
											$cancelledDate=$ol->item_cancelled_date;
										}else{
											$cancelledDate=$ol->order_cancelled_date;
										}									
                                        $newCancelDate = date("d-M-Y ", strtotime($cancelledDate));									 
									 echo $newCancelDate;?>
											
									 </td>
									 <td><?php echo $ol->user_name;?></td>
