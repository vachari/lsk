...
<style>
        ...
        input,select{padding: 5px 10px;margin-top:3px;}
                            ...
                            <tbody>
                                ...
                                <h4>
                                   ...
                                   <!--  <td> <?php // if($ol->cart_type   == 1){
                                       ...
                                       // }else{echo '<h4><label  class="label label-default">Sharecart </label> </h4>';} ?></td> -->
                                    <td><h3><b> <a href="<?php echo base_url().'superadmin/Orders/viewOrderDetails/'.base64_encode($ol->orderid).'/'.base64_encode($ol->cart_type);?>" class="btn link" target="_blank"><?php echo $ol->ordernumber;?> </a></h3></b></td>
                                    <td> <?php 
                                    ...
                                    -->
                                    <!-- <td> 
                                      <a href="<?php // echo base_url().'superadmin/Orders/pdf/'.base64_encode($ol->orderid).'/'.base64_encode($ol->cart_type);?>" class="btn btn-sm btn-primary" >Download </a>
                                    </td> -->
                                    <td class=" text-success">
                                      ...
                                      <a href="javascript:void(0)" class="btn btn-warning  btn-sm" onclick="updateState(<?php echo $ol->orderid; ?>, 3)"> Assign Shipper </a>  <br>
                                      <a href="javascript:void(0)" class="btn btn-danger  btn-sm" onclick="updateState(<?php echo $ol->orderid; ?>, 5)" > Cancel </a>  <br>
                                 ...
                                 <tfoot>
                                        ...
                                        <tr>
                                          <td colspan="3"> 
                                            ...
                                            <p> Displaying 1 to <?php if(isset($orders_list->result_count)) { echo $orders_list->result_count; } ?> of 
                                              <?php if(isset($rec_count)) { echo $rec_count; } ?> items </p>
                                            </td>
