                          ...
                          <div class="col-md-12">
                            ...
                            <div class="col-md-12" id='DivIdToPrint'>
                              <div class="col-md-12 mrtop" style="border: 1px solid #eee;margin: 15px;padding: 20px;">
                                      ...
                                      <table class="table borderless">
                                        ...
                                        <tfoot class="bg_darkgray">
                                          <tr>
                                            ...
                                            <td>
                                              <p class="bord"> &nbsp; <?php echo $od->orderqty; ?> Items</p>
                                            </td>
                                        ...
                                        <div class="col-md-12">
                                          <table class="table borderless">
                                            <tr>
                                              <td> Shipping Date : </td>
                                              <td>
                                                <p class="bord"> &nbsp;<?php echo date('M d, Y', strtotime($od->expected_delivery_date)); ?> </p>
                                              </td>
                                            ...
                                            <tr>
                                              <td> Track Number : </td>
                                              <td>
                                                <p> <?php echo $od->ordernumber; ?> </p>
                                              </td>
                                            </tr>
                                            <tr>
                                              <td> Shipping To : </td>
                                              <td>
                                                <p><?php echo $od->user_name; ?> </p>
                                                <p><?php echo $od->email; ?> / <?php echo $od->mobile; ?> </p>
                                                <p><?php echo $od->address; ?></p>
                                                <p><?php echo $od->city; ?>, <?php echo $od->pincode; ?></p>
                                              </td>
                                            </tr>
                                            <tr>
                                              <td> Shipping Form : </td>
                                              <td>
                                                <p>LSKCouriers </p>
                                                <p>Address : VIZAG</p>
                                                <p><?php echo 'VIZAG'; ?>, <?php echo $od->pincode; ?></p>
                                                <p>info@lskcourier.com</p>
                                ...
                                <?php $uri = base64_decode($this->uri->segment(5));
                                if ($uri == 1) { ?>
                         ...
                         <tr>";
                            ...
                            <tr border='1px'>
                                ...
                                <th><?php echo "₹ " . $cartStatisticsReq->cart_grand_total; ?></th>
                                    ...
                                    <form action="<?php echo base_url(); ?>superadmin/OrderApprove/changeOrderStatus" method="post">
                                      <input type="hidden" name="order_id" value="<?php echo $od->orderid; ?>" />
                                      <input type="hidden" name="order_number" value="<?php echo $od->ordernumber; ?>" />
                                      <input type="hidden" name="order_email" value="<?php echo $od->email; ?>" />
                                      <input type="hidden" name="order_phone" value="<?php echo $od->mobile; ?>" />
                                      <input type="hidden" name="order_backLink" value="<?php echo "http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']; ?>">
                                      <div class="row">
                                        <div class="col-md-3">
                                          <div>Current Status (Inprogress / Shipping / Delivered)</div>
                                          <div><input type="text" name="track_status" id="track_status" placeholder="Enter Current Status" class="form-control"></div>
                                        </div>
                                        <div class="col-md-3">
                                          <div>Shipping Notes</div>
                                          <div><textarea class="form-control" id="track_comments" name="track_comments" placeholder="Enter Shipping Notes"></textarea></div>
                                        </div>
                                        <div class="col-md-3">
                                          <div>&nbsp;</div>
                                          <div><input type="submit" id="track_submit" name="track_submit" class="btn btn-sm btn-primary" value="Submit"></div>
                                        </div>
                                      </div>
                                    </form>
                                  </div> <?php } else { ?>
