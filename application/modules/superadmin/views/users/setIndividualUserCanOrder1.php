          ...
          <?php if($this->session->flashdata('success')){?>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <?php if(!empty($individual_user_order_status->data_result[0]->status)){$status = $individual_user_order_status->data_result[0]->status;} ?>
            ...
            <div class="col-md-4">
             ...
             <div class="col-md-4">
                 ...
                 <table class="table table-hover">
                    <tr>
                        <th> Status : <h3><?php if(!empty($individual_user_order_status->data_result[0]->status)){echo $individual_user_order_status->data_result[0]->status;}else{echo 'Not Setted Yet';} ?> </h3></th>
                    </tr>
                </table>
             </div>
             </div>
