...
<head>
  ...
  <title><?php echo PROJECT_NAME;  ?> |Guest Users </title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Manage Guest User</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-4 ">
          ...
          <div class="col-md-9  ">
       <form method="post">
			     <input type="search" name="search" class="form-control" placeholder="Eg : Name ">
           </div>
            <div class="col-md-2  ">
      ...
      //alert(checklist);
        if (!isNaN(s) && (s == '1' || s == '0') && checklist != '') {
            ...
            $.ajax({
                dataType: 'json',
                type: 'post',
                data: {'tablename': 'guest', 'updatelist': checklist, 'activity': s},
    ...
    var listarray=new Array();
      ...
      if(checklist!=''){
         ...
         $.ajax({
          dataType:'json',
          type:'post',
          data:{'tablename':'guest','updatelist':checklist},
