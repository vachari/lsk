...
<head>
  ...
  <title><?php echo PROJECT_NAME;  ?> | Followers</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php  echo base_url().'superadmin/Users/viewPowerUsers';?>"><i class="fa fa-dashboard"></i> Manage Power User</a></li>
...
<?php //print_r($common_result);?>
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-2"><a href="<?php echo base_url().'superadmin/Users/viewPowerUsers';?>" class="btn btn-md btn-primary pull-right">Back</a></div>
      </div>
                                ...
                                foreach ($standard_res->common_result as $row) {
                                    ...
                                    <tr class="">
                                       ...
                                       <!--  <td> 
                                        ...
                                        <!-- <td><a href="<?php echo base_url().'superadmin/User/viewFollower'.$row->user_id;?>" class="btn btn-sm btn-info"> View </a></td> -->
                                    </tr> 
                                    <?php $i++;
                                }
                            } else { ?>
