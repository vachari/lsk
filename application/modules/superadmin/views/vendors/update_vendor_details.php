...
<head>
  ...
  <title><?php echo PROJECT_NAME;  ?> | Edit Vendor Profile</title>
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <?php
                            ...
                            echo form_open('superadmin/Vendors/updateVendorDetails', $form_attributes);
                         ?>
            <div class="box-body">
            <div class="col-md-4">
              <div class="form-group">
              <input type="hidden" name="vendor_id" id="vendor_id" value="<?php echo $vendor_records->vendor_id;?>"/>
            <?php   $data1 = array(
                            'name' => 'vendor_code',
                            'id' => 'vendor_code',
                            'maxlength' => 20,
                            ...
                            'value'=>$vendor_records->vendor_code
                        );
            ...
            <div class="col-md-4">
              ...
              <?php  $data2 = array(
                            ...
                            'value'=>$vendor_records->vendor_name
            ...
            if($vpd!=null){ $cd=$vpd->no_of_days_credit_from_delivery_date;}else{$cd='';}
              $data1 = array(
                            ...
                            'value'=>set_value('no_of_days_credit_from_delivery_date',$cd),
                            'maxlength'=>10
                        );
           ...
           if($vpd!=null){ $ptd=$vpd->payment_terms_description;}else{$ptd='';}
            $data1 = array(
              ...
              <?php if($vendor_contacts !=null){ ?>
               <h4>Edit Vendor Contacts</h4><hr>
              <?php $i=0; foreach ($vendor_contacts as $row) {  ?>
                  <div class="col-md-12">
                  <input type="hidden" name="<?php echo 'id'.$i; ?>" value="<?php echo $row->id ?>"> 
                    <div class="col-md-2" style="padding-left: 0px;">
                     <label> Contact Person Code</label><span style="color:red;"><?php echo form_error('vcp_code'); ?></span><input type="text" class="form-control" name="vcp_code[]" autocomplete="off" value="<?php echo set_value('vcp_code',$row->contact_person_code); ?>" maxlength="3">
                    </div>
                    <div class="col-md-3"><label> Contact Person Name</label><span style="color:red;"><?php echo form_error('vcp_name'); ?></span><input type="text" class="form-control" name="vcp_name[]" autocomplete="off" value="<?php echo set_value('vcp_name',$row->contact_person_name); ?>"></div>
                    <div class="col-md-3"><label> Contact Person Email</label><span style="color:red;"><?php echo form_error('vcp_email'); ?></span><input type="text" class="form-control" name="vcp_email[]" autocomplete="off" value="<?php echo set_value('vcp_email',$row->contact_person_email); ?>"></div>
                    <div class="col-md-3"><label> Contact Person Mobile</label><span style="color:red;"><?php echo  form_error('vcp_mobile'); ?></span><input type="text" class="form-control number_class" name="vcp_mobile[]" autocomplete="off" value="<?php echo set_value('vcp_mobile',$row->contact_person_mobile); ?>" maxlength="10"></div>
                    <div class="col-md-1"><a href="<?php echo base_url().'superadmin/Vendors/delete_vendor_contact/'.base64_encode($row->id); ?>" onclick="return confirm('Confirm to delete ?');"><i class="glyphicon glyphicon-remove" style="padding-top: 30px !important;color: red;"></i></a></div>
                   </div>
               <?php $i++; }

              } else{ ?>
                <div class="col-md-12 text-center text-danger"><b>Vendor Contacts Not Found</b></div>
                <div class="clearfix">&emsp;</div>
              <?php }?>
               <div class="col-md-12"> 
                    <div class="col-md-2" style="padding-left: 0px;">
                     <label> Contact Person Code</label><span style="color:red;"><?php echo form_error('vcpcode'); ?></span><input type="text" class="form-control" name="vcpcode[]" autocomplete="off" value="<?php echo set_value('vcp_code'); ?>" maxlength="3">
                    </div>
                    <div class="col-md-3"><label> Contact Person Name</label><span style="color:red;"><?php echo form_error('vcpname'); ?></span><input type="text" class="form-control" name="vcpname[]" autocomplete="off" value="<?php echo set_value('vcpname'); ?>"></div>
                    <div class="col-md-3"><label> Contact Person Email</label><span style="color:red;"><?php echo form_error('vcpemail'); ?></span><input type="text" class="form-control" name="vcpemail[]" autocomplete="off" value="<?php echo set_value('vcpemail'); ?>"></div>
                    <div class="col-md-3"><label> Contact Person Mobile</label><span style="color:red;"><?php echo  form_error('vcpmobile'); ?></span><input type="text" class="form-control number_class" name="vcpmobile[]" autocomplete="off" value="<?php echo set_value('vcpmobile'); ?>" maxlength="10"></div>
         ...
         $("#btn_submit").click(function(){
           ...
           var website=$('#website').val();
            ...
            if(mobile!="" && !mobilepattern.test(mobile)){
                ...
                $('#mobile').css('border','1px solid red');
                $('#mobile_err').css('color','red');
                $('#mobile_err').html(' Please Enter valid Mobile');
                  }            
           if(city==''|| city==' '){
                str=false;
