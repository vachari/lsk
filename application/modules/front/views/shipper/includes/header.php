    ...
    <div class="container">
            ...
            <div class="col-md-4 col-xs-6 no-pad">
                <div class="col-md-12 pull-right side-left">
                    <?php if ($this->shipper_id !='') { 
                      $user=$this->session->userdata('shipper_name');
                      if(strlen($user) > 20){
                        $user=substr($user, 0,17).'...';
                      }
                      ?>
                        <ul class="list-inline col-md-12 no-pad ">
                            <li class="text-capitalize"><a href="<?php echo base_url().'shipper'; ?>"> <b> &nbsp;</b><?php echo 'Hi '.$user; ?> </a></li>
                            <li><a href="<?php echo base_url() . 'shipper/profile/'; ?>" >My Profile</a></li>
                            <li><a href="<?php echo base_url() . 'shipper/logout'; ?>" class="no-brd">Logout</a></li>
                        </ul>
                        <p style="color: #fff" class="text-right">  Shipper Panel </p>
                        <?php
                    } ?>
