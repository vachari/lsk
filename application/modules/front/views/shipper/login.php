            ...
            <div class="col-md-12 "> 
               <div class="container">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Shipper Login</li>
                    </ol>
                </div>
            ...
            <div class=" col-md-12 "> 
                ...
                ?>
                    ...
                    <div class="col-md-4 col-md-offset-4">
                        <h2 class="text-center col-md-12 "> <b>Shipper Login</b>  </h2>
                        <div class=" col-md-12">
                            <?php echo form_open('shipper/logging',array('id'=>'login_form','name'=>'login_form'))?>
                             ...
                             <div class="form-group col-md-12">
                               <span id="password_login_error" style="color: red"><?php echo form_error('login_password'); ?></span>
                                <input type="password" name="login_password" id="login_password" placeholder="Password" class="form-control" autocomplete="off" max="60" min="6">
                                 ...
                                 <p class="pull-right"><a href="<?php echo base_url().'shipper/forgot-password' ?>"> Forgot Password ?</a></p>
                            </div>
               ...
               <!--<div class="col-md-12">
                    <a href="<?php echo base_url().'vendor';?>" class="btn btn-md btn-danger pull-right" >Login as a Vendor</a>
                    <br><br>
                </div>   -->
                <br>
                <br>
