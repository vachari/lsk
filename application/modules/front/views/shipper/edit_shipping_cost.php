        ...
        <div class="container martop150">
            ...
            <div class="col-md-9">
               ...
               <?php if ($this->session->flashdata('Failed')) { ?>
                    ...
                    <?php echo form_open('shipper/shipping-cost-updating',array('id'=>'shipping_cost_form','name'=>'shipping_cost_form','method'=>'post'))?>
            ...
            <div class="col-md-12">
              <div class="form-group">
               <?php $data6 = array(
                        ...
                        <a href="<?php echo base_url().'shipper/manage-shipping-cost' ?>" class="btn btn-warning">Go Back</a>     
