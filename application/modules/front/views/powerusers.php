      ...
      <div class="col-sm-10 col-sm-offset-1 bg_profile border">
        ...
        <input type="hidden" name="username" id="username-<?php echo $row->user_id; ?>" value="<?php echo $row->user_name; ?>">
         <div class="col-sm-3">
            ...
            <?php if($this->user_id){ ?>
                  <button type="button" class="btn btn-md btn-primary" onclick="power_user(<?php echo $row->user_id ; ?>)">Follow</button>
         <?php } else{ ?>
...
<script type="text/javascript">
   function power_user(id){
    ...
    if(useremail!="" && username!=""){
         $.ajax({
            url: '<?php echo base_url(); ?>front/User/poweruser_request',
            method: 'POST',
