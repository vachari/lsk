            ...
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <div class="contact_message content">
                        ...
                        <ul>
                            <li><i class="fa fa-fax"></i> Address : Vizag, Andhra pradesh</li>
                            <li><i class="fa fa-phone"></i> Info@lskglobal.com</li>
                            <li><i class="fa fa-envelope-o"></i> +91 7981186263</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12">
