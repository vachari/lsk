                     ...
                     <div class="product_content grid_content">
                       ...
                       <div class="action_links">
                         <ul>
                           ...
                           <li class="add_to_cart"><a href="javascript:void(0)" onclick="addToCart('<?php echo $fpro->id; ?>') title=" add to cart"><i class="zmdi zmdi-shopping-cart-plus"></i> add to cart</a></li>
 ...
 <script type="text/javascript">
   $(document).ready(function() {
     $('.wishlist').on('click', function() {
       var sess_id = "<?php echo $this->session->userdata('user_id'); ?>";
       if (sess_id != '') {
         if ($(this).find("i").attr('class') == "fa fa-heart pull-right wishheart") {
           $(this).find("i").removeClass();
           $(this).find("i").addClass("fa fa-heart-o pull-right wishheart");
         } else {
           $(this).find("i").removeClass();
           $(this).find("i").addClass("fa fa-heart pull-right wishheart");
         }
       } else {
       ...
       if (p_id) {
         $.ajax({
           method: "POST",
           url: "<?php echo base_url(); ?>front/products/addRemoveWishlist",
           data: {
             p_id: p_id
           },
         });
   ...
   function addToCart(id) {
     ...
     $.ajax({
       ...
       url: '<?php echo base_url(); ?>addtobasket',
