            ...
            <div class="col-md-9">
                <div class="col-md-12">
                    ...
                    <div class="header-title mrtop">
                        <h4>Your Power User Shared Cart List</h4>
                    ...
                    <?php //print_r($cart_data);?>
                        <table class="table  table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td> <?php echo  $i ?></td>
									<td><?php echo  ucfirst($sc->user_name);?></td>
                                   <!-- <td><?php echo  $sc->session_id ?></td>-->
                                    <td><?php echo  date('d-m-Y',strtotime($sc->shared_on)) ?></td>
                                    <td><?php echo  date('d-m-Y',strtotime($sc->end_date)) ?></td>
                                    ...
                                    <td><a href="<?php echo base_url();?>checkout" class="btn btn-primary btn-xs"> View </a>
									<a href="<?php echo base_url();?>" class="btn btn-primary btn-xs">Add Items </a>
									</td>
                                     <?php } ?>
                                </tr>
