            ...
            <div class=" col-md-12 "> 
                ...
                ?>
                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <h3 class="text-center col-md-10 "> <b>Forgot Password</b>  </h3>
                            <div class=" col-md-12">
                            <?php echo form_open('sending-reset-password-link',array('id'=>'forgot_form','name'=>'forgot_form'))?>
                            ...
                            <div class="form-group col-md-10 text-center">
                                ...
                                <a href="<?php echo base_url().'register' ?>" class="btn btn-md btn-warning"> Login </a>
                            </div>
                            <div class="clearfix"></div>
                            <?php echo form_close() ?>
                    </div>
