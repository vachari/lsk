...
<head> 
    ...
    <title>:: Shoperative | Add Shipping Cost ::</title>
        ...
        <div class="container martop150">
            ...
            <div class="col-md-9">
               ...
               <?php if ($this->session->flashdata('Failed')) { ?>
                    ...
                    <?php echo form_open('vendor/add-shipping-cost',array('id'=>'shipping_cost_form','name'=>'shipping_cost_form','method'=>'post'))?>
           ...
           <label>Shipper</label><span class="err_class" id="shipper_err" style="color:red;">*</span>
                            ...
                            <?php
                                ...
                                if ($shipper_res->code == SUCCESS_CODE) {
                                    foreach ($shipper_res->result as $shipper) {
                                        ?>
                                        <option value="<?php echo $shipper->shipper_id; ?>" <?php echo set_select('shipper',$shipper->shipper_id) ?> ><?php echo ucfirst($shipper->shipper_name).' ('.$shipper->shipper_code.' )'; ?></option>
                                        <?php
                                    }
                                }
                                ?>
            ...
            <div class="col-md-4">
              ...
              <?php  $data2 = array(
                            ...
                            'value' =>  set_value('distance_range_from')
                        );
            ...
            <div class="col-md-4">
              ...
              <?php  $data3 = array(
                            ...
                            'value' =>  set_value('distance_range_to')
                        );
            ...
            <div class="col-md-8">
              <div class="form-group">
               <?php $data5 = array(
                            ...
                            'value' =>  set_value('std_delivery_days_from_order_date')
            ...
            <div class="col-md-12">
              <div class="form-group">
               <?php $data6 = array(
                            ...
                            'value' =>  set_value('special_conditions')
