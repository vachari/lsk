            ...
            <div class="col-md-9">
                ...
                <?php
                    ...
                    <div class="header-title">
                        <h4>Orders Due For Delivery By Due Date</h4>
                        <hr style="margin-top: -5px;"> 
                    </div>
                   
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <form method="post" action="<?php echo base_url().'vendor/search-orders-due-for-delivery-by-due-date' ?>">
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                    ...
                    <a href="<?php echo base_url().'vendor/orders-due-for-delivery-by-due-date' ?>" class="btn btn-sm btn-info">Refresh</a>
                  </div>
                  </form>
