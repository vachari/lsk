            ...
            <div class="col-md-12 "> 
               <div class="container">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Vendor Forgot Password</li>
                    </ol>
                </div>
            ...
            <div class=" col-md-12 "> 
                ...
                ?>
                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <h3 class="text-center col-md-10 "> <b>Vendor Forgot Password</b>  </h3>
                        <div class=" col-md-12">
                            <?php echo form_open('vendor/sending-reset-password-link',array('id'=>'forgot_form','name'=>'forgot_form'))?>
                            ...
                            <div class="form-group col-md-10 text-center">
                                <a href="<?php echo base_url().'vendor/login' ?>" class="btn btn-md btn-warning"> Login </a>
