...
<head> 
    ...
    <title>:: Shoperative | Add Product ::</title>
    ...
    <section>
        <div class="container martop150">
                            ...
                            <select name="unit_id" id="unit_id" class="form-control "> 
                                ...
                                if ($units->code == SUCCESS_CODE) {
                                    foreach ($units->result as $units_response) {
                                        ?>
                                        <option value="<?php echo $units_response->id; ?>" <?php echo set_select('unit_id',$units_response->id) ?>><?php echo $units_response->unit_code; ?></option>
                                        <?php
                                    }
                                }
                                ?>
                            ...
                            <select name="group_id" id="group_id" class="form-control ">
                                ...
                                if ($groups->code == SUCCESS_CODE) {
                                    foreach ($groups->result as $group_response) {
                                        ?>
                                        <option value="<?php echo $group_response->id; ?>" <?php echo set_select('group_id',$group_response->id) ?>><?php echo $group_response->group_name.'('.$group_response->group_code.')'; ?></option>
                                        <?php
                                    }
                                }
                                ?>
            ...
            <div class="col-md-4">
                            ...
                            <select name="menu_id" id="menu_id" class="form-control ">
                                ...
                                if($categories->code==200){
                                    foreach ($categories->result  as $catrow) {
                                        ?>
                                        <option value="<?php echo $catrow->menu_id; ?>" <?php echo set_select('menu_id',$catrow->menu_id) ?> >
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                              <?php echo form_label('Feature Product Status', 'feature_product'); ?>
                            <span style="color:red;" id="feature_product_err"> *</span> 
                            <select name="feature_product" id="feature_product" class="form-control ">
                                <option value="0" <?php echo set_select('feature_product',0) ?>>In-Active</option>
                                <option value="1" <?php echo set_select('feature_product',1) ?>>Active</option>
                            </select>
                            <span class="err_class" id="listsubmenu_err"></span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="shelf_life_unit" id="shelf_life_unit" class="form-control">
                                ...
                                <option value="Days" <?php echo set_select('shelf_life_unit','Days') ?>>Days</option>
                                <option value="Weeks" <?php echo set_select('shelf_life_unit','Weeks') ?>>Weeks</option>
                                <option value="Months" <?php echo set_select('shelf_life_unit','Months') ?>>Months</option>
                                <option value="Years" <?php echo set_select('shelf_life_unit','Years') ?>>Years</option>
                            </select>
           ...
           $('#insertproduct').on('submit', function (i) {
                ...
                if (image != '')
                {
                    ...
                    if (validformat == false)
                    {
                        ...
                        $('#prod_img_err').text('Upload valid jpeg,jpg,png,gif image only');
                        str = false;
                    }
                }
                if (str == true) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo base_url(); ?>front/vendor/add_product_details",
                        contentType: false,
                        cache: false,
                        processData: false,
                        success: function (data) {
                            ...
                            switch (data.code)
                            {
                                case 200:
                                    ...
                                    $('.success_msg').html('Data Added Successfully').addClass('alert alert-success fade in');
                                    setTimeout(function () {
