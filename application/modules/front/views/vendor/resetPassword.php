            ...
            <div class="col-md-12 "> 
               <div class="container">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Vendor Reset Password</li>
                    </ol>
                </div>
            ...
            <div class=" col-md-12 "> 
                ...
                ?>
                    ...
                    <div class="col-md-4 col-md-offset-4">
                        <h4 class="text-center col-md-10 "> <b>Vendor Reset Password </b>  </h4>
                        <div class=" col-md-12">
                            <?php echo form_open('vendor/resetting-password',array('id'=>'reset_form','name'=>'reset_form'))?>
