                ...
                <div class="col-xs-12 mrtop">
                     <ul class="profile-side-bar">
                        <li> <a href=" <?php echo base_url().'vendor/dashboard'; ?>"> Dashboard</a></li>
                         ...
                         <li class="active"> <a href="#">Product Group Wise Prices</a></li>
            ...
            <div class="col-md-9">
                ...
                <?php
                    ...
                    <div class="header-title">
                        <h4>Manage Product Group Wise Prices</h4>
                        <hr style="margin-top: -5px;"> 
                    </div>
                   
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <form method="post" action="<?php echo base_url().'vendor/search-product-group-wise-price' ?>">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                    <input type="text" class="form-control" name="search_name" placeholder="Product Name/SPC/VPC" value="<?php if(isset($search['search_name']) && $search['search_name']!=null) echo $search['search_name'] ?>">
                  </div>
                  <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                  <select class="form-control selectpicker select2" name="group" id="group"> 
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    ...
                    <a href="<?php echo base_url().'vendor/product-group-wise-prices' ?>" class="btn btn-sm btn-info">Refresh</a>&emsp;&emsp;&emsp;
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            <?php  
                                   ...
                                   if($product_group_prices->code != 200 ){

                                    echo '<tr> <td colspan=13> <div class="alert alert-danger text-center">Data not found</div></td></tr>';

                                   }else{
                                    $srno=$this->uri->segment(3,0);
                                    $i=$srno+1;
                                    foreach ($product_group_prices->result as $row) {
                                     
                                ?>
                        <tr>
                        <td><input type="checkbox" name="multiple[]" class="checkSingle" value="<?php echo $row->id; ?>"></td>
                        <td><?php echo  $i ?></td>
                        <td><?php echo  $row->group_name.'('.$row->group_code.')'; ?></td>
                        ...
                        <td><a href="<?php echo base_url().'vendor/edit-product-group-price/'.base64_encode($row->id); ?>" class="btn btn btn-primary btn-xs">Edit</a></td>
      ...
      //alert(checklist);
        if (!isNaN(s) && (s == '1' || s == '0') && checklist != '') {
            ...
            $.ajax({
                dataType: 'json',
                type: 'post',
                data: {'tablename': 'productgroupprice', 'updatelist': checklist, 'activity': s},
       ...
       var confirmation=confirm('Are you sure to delete selected records?');
        if(confirmation==true){
         ...
         $.ajax({
          dataType:'json',
          type:'post',
          data:{'tablename':'productgroupprice','updatelist':checklist},
