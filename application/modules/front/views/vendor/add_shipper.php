...
<head> 
    ...
    <title>:: Shoperative | Add Shipper ::</title>
        ...
        <div class="container martop150">
            ...
            <div class="col-md-9">
               ...
               <?php if ($this->session->flashdata('Failed')) { ?>
                    ...
                    <?php echo form_open('vendor/add-shipper',array('id'=>'shipper_form','name'=>'shipper_form'))?>
