        ...
        <div class="container martop150">
                ...
                <div class="col-xs-12 mrtop">
                     <ul class="profile-side-bar">
                        <li> <a href=" <?php echo base_url().'vendor/dashboard'; ?>"> Dashboard</a></li>
                         ...
                         <li class="active"> <a href="#">Manage Shipping Cost</a></li>
            ...
            <div class="col-md-9">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <form method="post" action="<?php echo base_url().'vendor/search-shipping-cost' ?>">
                  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                    <input type="text" class="form-control" name="search_name" placeholder="Search by Shipper Code/Name" value="<?php if(isset($search['search_name']) && $search['search_name']!=null) echo $search['search_name'] ?>">
                  </div>
                  <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                    <input type="submit" name="search_btn" value="Search" id="search_btn" class="btn btn-sm btn-info">
                    <a href="<?php echo base_url().'vendor/manage-shipping-cost' ?>" class="btn btn-sm btn-info">Refresh</a>
                  </div>
                  </form>
                  <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                    <a href="<?php echo base_url().'vendor/add-shipping-cost' ?>" class="btn btn-sm btn-info"><span class="fa fa-plus"> </span> Add New</a>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive">
                  ...
                  <table width="100%" class="table table-bordered table-hover table-striped">
                    ...
                    <tbody>
                        ...
                        <?php  
                                $shipping_cost=json_decode($shippingcostdata);
                                   if($shipping_cost->code != 200 ){
                                    ...
                                    echo '<tr> <td colspan=13> <div class="alert alert-danger text-center">Shipping cost data not found</div></td></tr>';
                        ...
                        <td><?php echo  $i ?></td>
                        <td><?php echo  $shipping->shipper_code; ?></td>
                        <td><?php echo  $shipping->shipper_name; ?></td>
                        ...
                        <td><a href="<?php echo base_url().'vendor/edit-shipping-cost/'.base64_encode($shipping->shipping_cost_id); ?>" class="btn btn btn-primary btn-xs">Edit</a></td>
