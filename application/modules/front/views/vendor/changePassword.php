        ...
        <div class="container martop150">
                ...
                <div class="col-xs-12 mrtop">
                     <ul class="profile-side-bar">
                        <li> <a href=" <?php echo base_url().'vendor/dashboard'; ?>"> Dashboard</a></li>
                         ...
                         <li class="active"> <a href=" <?php echo base_url() . 'vendor/change-password'; ?>"> Change Password   </a></li>
            ...
            <div class="col-md-9">
                ...
                <?php
                    ...
                    <?php echo form_open('vendor/changging-password',array('id'=>'change_password_form','name'=>'change_password_form'))?>
                    <div class=""> 
