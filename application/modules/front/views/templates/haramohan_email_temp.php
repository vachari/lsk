  ...
  <body>
   <div class="container" style="border:1px solid #eee;">
        <table class="table table-bordered">
            ...
            <tr >
                <th>Email  for Login</th><td> <?php echo $email; ?></td>
            </tr>
            <tr>
                <th>Password for Login</th><td> <?php echo $follower_password; ?></td>
            </tr>

            <tr>
                <th>Login</th><td> <a href="<?php echo base_url();?>signin">Login</a></td>
            </tr>
            <?php  ?>
        </table>
    </div>
