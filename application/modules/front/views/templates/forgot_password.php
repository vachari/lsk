  ...
  <body>
   <div class="container">
        <table class="table table-nobordered">
            ...
            <tr>
            	<th colspan="4"><h3>Reset Password Link</small></h3>	</th>
            </tr>
            <tr >
                <th colspan="4"> <?php echo 'You have requested for the reset your shoperative password. You can reset your password by clicking on Reset Password';?> <br><br>
                  <a href="<?php echo $email_content['link']; ?>" class="btn btn-sm btn-info "> Reset Password </a></th>
            </tr>
