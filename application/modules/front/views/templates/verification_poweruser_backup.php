   ...
   <div class="col-md-6" style="border:2px solid green;" >
        <table class="table table-nobordered" width="100%">
            ...
            <tr style="background: green;color:#fff;">
            	<th colspan="4" style="text-align: center;"><h4> Welcome to Shoperative </h4>	</th>
            </tr>
            <tr><td colspan="5">
              <br>
              ...
              Welcome to Shoperative.
                ...
                <br> 
                <p>
                  We are excited to add you as a Power User to the SHOPERATIVE community. <br>
                 Your account successfully registered. To activate your account, please click on the link below.
                </p>
                <br>
                <b>Activation Link : </b>
                ...
                <br><br>
                <p>
                  For any queries or help, please contact us at info@shoperative.com . Wish you a long and fruitful association with Shoperative.
                </p>
                <br>
                Thank you,<br>
                Team Shoperative
