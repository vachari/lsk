  ...
  <body>
   <div class="container">
        <table class="table table-nobordered">
            ...
            <tr >
                <th colspan="4"> <?php echo 'Your <b>Shipper Account</b> has been <b>Created</b> successfully. You can login with credentials given below:';?> <br>
                  <b>Email : <?php echo $email_content['email']; ?></b><br>
                  <b>Password : <?php echo $email_content['temp_password']; ?></b><br>
                  <a href="<?php echo $email_content['link']; ?>" class="btn btn-sm btn-info "> Click here to Login</a></th>
            </tr>
