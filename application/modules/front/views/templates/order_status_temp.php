...
<body>
        ...
        <table class="table table-bordered">
            <tr>
                <th colspan="4" class="text-center">
                    <center>
                        <a href="<?php echo SITE_DOMAIN ?>"><img src="<?php echo PROJECT_LOGO; ?>" alt="" class="img-responsive"></a>
                    </center>
                </th>
            </tr>
                    ...
                    <div class="panel-body">
                        <div class="col-md-9">
                            <table class="table borderless" width="400">
                                <caption class="bg_darkgray"> <b> &nbsp; Basic Details</b></caption>
                                <tr>
                                    <?php
    ...
    <div class="footer">
        <div class="container bg_darkgray">
            <p class="" style="text-align: center;padding: 10px"> All &copy; Rights Reserved by <?php echo PROJECT_NAME; ?> <?php echo date('Y'); ?>. </p>
        </div>
    </div>
