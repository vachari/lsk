  ...
  <body>
   <div class="container" style="border:1px solid #eee;">
        <table class="table table-bordered">
            ...
            <tr>
            	<th colspan="4"><h3> Dear <?php echo $user_details['name']; ?>  Welcome to Shoperative <br><small>Thank you for joining with us!</small></h3>	</th>
            </tr>
            <tr >
                <th>Link to Login  </th><td> <a href="<?php echo $user_details['link']; ?>" class="btn btn-sm btn-primary">Click here to be a Power User</a></td>
            </tr>
            <tr>
