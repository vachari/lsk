...
<div style="width:60%;float: right">
    ...
    <div style="background-color:#ffffff;color:#333;padding:20px 21px;">
      <p style="line-height: 26px;"><b>Welcome to the Shoperative community, India’s national network of Food Co-operatives.
</b></p>    
        
  <p style="line-height: 26px;"><b>You are registered as a Power-user. You need to confirm your mail id, before you start inviting your co-shoppers as your followers and  build your own Food-Cooperative online at Shoperative.in.
</b></p>
  <!--<p style="line-height: 26px;">Dear <b>User</b>,</p>-->
  
  <p style="line-height: 26px;">
   <a href="<?php echo $user_data['link']; ?> " class="btn btn-info btn-sm">Click here  </a>  to confirm your mail id.</p>
