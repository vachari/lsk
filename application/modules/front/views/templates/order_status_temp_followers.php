...
<div style="width:60%;float: right">
  ...
  Your power-user:<?php echo $power_username;?> confirmed your Order with reference #:<?php echo $order_number;?> dated.<?php echo $newDate;?> 
</p>
  <p>Your order would be processed within 2 business days, and will be shipped within 4-5 business-days.</p>
  <p>You may view your order status <a href="<?php echo base_url();?>signin"> here </a></p>
