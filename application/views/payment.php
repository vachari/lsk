...
<body>
    <form method="post" name="customerData" action="<?php echo base_url() . 'Paymentcc/processPayment'; ?>">
        ...
        <table width="40%" height="100" border='1' align="center">
            ...
            <tr>
                <td>Merchant Id :</td>
                <td><input type="text" name="merchant_id" value="2576880" /></td>
            </tr>
            <tr>
                <td>Order Id :</td>
            ...
            <tr>
                <td>Redirect URL :</td>
                <td><input type="text" name="redirect_url" value="<?php echo base_url() . 'Paymentcc/paymentSuccess'; ?>" /></td>
            </tr>
            <tr>
                <td>Cancel URL :</td>
                <td><input type="text" name="cancel_url" value="<?php echo base_url() . 'Paymentcc/paymentFail'; ?>" /></td>
            </tr>
            <tr>
                <td>Language :</td>
            ...
            <tr>
                <td>Billing Name :</td>
                <td><input type="text" name="billing_name" value="Venkatesh" /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Billing City :</td>
                <td><input type="text" name="billing_city" value="Hyderabad" /></td>
            </tr>
            <tr>
                <td>Billing State :</td>
                <td><input type="text" name="billing_state" value="Tg" /></td>
            </tr>
            <tr>
                <td>Billing Zip :</td>
                <td><input type="text" name="billing_zip" value="500090" /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Billing Tel :</td>
                <td><input type="text" name="billing_tel" value="9182900940" /></td>
            </tr>
            <tr>
                <td>Billing Email :</td>
                <td><input type="text" name="billing_email" value="vachari010@gmail.com" /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Shipping Name :</td>
                <td><input type="text" name="delivery_name" value="Venkatesh" /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="delivery_state" value="TG" /></td>
            </tr>
            <tr>
                <td>shipping Zip :</td>
                <td><input type="text" name="delivery_zip" value="500090" /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Shipping Tel :</td>
                <td><input type="text" name="delivery_tel" value="9182900940" /></td>
            </tr>
            <tr>
